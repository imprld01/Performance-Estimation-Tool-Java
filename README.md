...
If you want to use eclipse to develop JavaFx application, you can install the extension [e(fx)clipse](http://www.eclipse.org/efxclipse/install.html), which url is http://download.eclipse.org/efxclipse/updates-released/2.4.0/site, on eclipse using the "Install New Software" wizard.
